...
public class MainActivity extends Activity {
    ...
    private void configureWebView() {
        ...
        // V4: desktop-browser compatibility test.
        // The TV's built-in Chrome can render Shahid's desktop site correctly, while
        // the Android/WebView identity is offered a mobile/TV flow that asks for the app.
        // We therefore use a normal desktop Chrome UA for page-compatibility testing.
        // This does not add or bypass any DRM/content-protection mechanism.
