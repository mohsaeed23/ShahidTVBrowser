...
public class MainActivity extends Activity {
    ...
    private void configureWebView() {
        ...
        // Use the native KitKat Chromium identity. Do not pretend to be a modern Chrome:
        // the engine itself is old, and advertising a newer browser can make modern
        // sites send JavaScript/CSS that this WebView cannot parse.
