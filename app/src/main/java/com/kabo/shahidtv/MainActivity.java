...
public class MainActivity extends Activity {
    ...
    private void configureWebView() {
        ...
        // V3: emulate the Android 4.4 Chrome/WebView identity as closely as possible.
        // Android 4.4 Chrome/WebView used Chromium 30 and a UA containing Version/4.0.
        // We deliberately do NOT advertise a modern Chrome version because the actual
        // rendering engine on this TV is still the KitKat Chromium engine.
        String model = Build.MODEL == null ? "KABO-TV" : Build.MODEL;
        String build = Build.ID == null ? "KABO" : Build.ID;
        String ua = "Mozilla/5.0 (Linux; Android 4.4.4; " + model + " Build/" + build + ") " +
